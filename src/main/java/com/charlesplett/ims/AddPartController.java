...
public class AddPartController implements Initializable {
    ...
    /**
     * OnAction method to save a new Part. Adds new part to inventory after validation.
     */
    @FXML
    public void save(){
    ...
    /**
     * Method called on init. Sets the id field to the next available ID. 
     */
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        idField.setText(String.valueOf(this.getNextId()));
    }    
